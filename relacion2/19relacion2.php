    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h4>Ejercicio 19 Relacion 2 - Conversor a bin, octal, hexa</h4>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="base" class="form-label">Selecciona la base:</label>
                ...
                <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["numero"], $_POST["base"])) {
